...
The command service file deals with parsing and reading commands, and calling the appropriate functions, which are also contained in this file. It provides most of the functionality associated with the commands. For example, it contains our function to create new processes, to print a pids stats, and to send stop/start/kill signals to our processes.


# Other notes

- ProcessList and CommandService each have header files associated with them.
